 ...
 */
    ...
    class tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_iggPage extends DetailPage
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), '(SELECT id_gerenciador = %CURRENT_USER_ID%)
            '));
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_id_gerenciador_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('id_gerenciador', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_id_gerenciador_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idConcessiona_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idConcessiona', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idConcessiona_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idPista_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idPista', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idPista_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idSentidotrafego_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idSentidotrafego', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idSentidotrafego_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idFaixa_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idFaixa', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idFaixa_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_id_via_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('id_via', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_id_via_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_id_secao_terrap_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('id_secao_terrap', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_id_secao_terrap_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_tipo_revestimento_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('tipo_revestimento', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_tipo_revestimento_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idInterferencia_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idInterferencia', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idInterferencia_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Usuário', 'id_gerenciador', 'id_gerenciador_Nome Operador', 'edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_id_gerenciador_search', $editor, $this->dataset, $lookupDataset, 'idUsuario', 'Nome Operador', '');
            ...
            $editColumn = new DynamicLookupEditColumn('Lote', 'idConcessiona', 'idConcessiona_Lote', 'edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idConcessiona_search', $editor, $this->dataset, $lookupDataset, 'idConcessiona', 'Lote', '');
            ...
            $editColumn = new DynamicLookupEditColumn('Pista', 'idPista', 'idPista_DescricaoPista', 'edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idPista_search', $editor, $this->dataset, $lookupDataset, 'idPista', 'DescricaoPista', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Sentido tráfego (quilometragem)', 'idSentidotrafego', 'idSentidotrafego_Descricao', 'edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idSentidotrafego_search', $editor, $this->dataset, $lookupDataset, 'idSentidotrafego', 'Descricao', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Faixa', 'idFaixa', 'idFaixa_DescricaoFaixa', 'edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idFaixa_search', $editor, $this->dataset, $lookupDataset, 'idFaixa', 'DescricaoFaixa', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Via', 'id_via', 'id_via_DescricaoVia', 'edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_id_via_search', $editor, $this->dataset, $lookupDataset, 'idVia', 'DescricaoVia', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Seção Terrap.', 'id_secao_terrap', 'id_secao_terrap_DescricaoSecao', 'edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_id_secao_terrap_search', $editor, $this->dataset, $lookupDataset, 'idSecao', 'DescricaoSecao', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Tipo Revestimento', 'tipo_revestimento', 'tipo_revestimento_DescricaoMaterial', 'edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_tipo_revestimento_search', $editor, $this->dataset, $lookupDataset, 'idMaterial', 'DescricaoMaterial', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Interferência', 'idInterferencia', 'idInterferencia_tipo_interferncia', 'edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idInterferencia_search', $editor, $this->dataset, $lookupDataset, 'idInterferencia', 'tipo_interferncia', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('Nome Operador', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Usuário', 'id_gerenciador', 'id_gerenciador_Nome Operador', 'multi_edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_id_gerenciador_search', $editor, $this->dataset, $lookupDataset, 'idUsuario', 'Nome Operador', '');
            $editColumn->SetReadOnly(true);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            $lookupDataset->setOrderByField('Lote', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Lote', 'idConcessiona', 'idConcessiona_Lote', 'multi_edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idConcessiona_search', $editor, $this->dataset, $lookupDataset, 'idConcessiona', 'Lote', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('DescricaoPista', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Pista', 'idPista', 'idPista_DescricaoPista', 'multi_edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idPista_search', $editor, $this->dataset, $lookupDataset, 'idPista', 'DescricaoPista', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('Descricao', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Sentido tráfego (quilometragem)', 'idSentidotrafego', 'idSentidotrafego_Descricao', 'multi_edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idSentidotrafego_search', $editor, $this->dataset, $lookupDataset, 'idSentidotrafego', 'Descricao', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('DescricaoFaixa', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Faixa', 'idFaixa', 'idFaixa_DescricaoFaixa', 'multi_edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idFaixa_search', $editor, $this->dataset, $lookupDataset, 'idFaixa', 'DescricaoFaixa', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('DescricaoVia', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Via', 'id_via', 'id_via_DescricaoVia', 'multi_edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_id_via_search', $editor, $this->dataset, $lookupDataset, 'idVia', 'DescricaoVia', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('DescricaoSecao', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Seção Terrap.', 'id_secao_terrap', 'id_secao_terrap_DescricaoSecao', 'multi_edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_id_secao_terrap_search', $editor, $this->dataset, $lookupDataset, 'idSecao', 'DescricaoSecao', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('DescricaoMaterial', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Tipo Revestimento', 'tipo_revestimento', 'tipo_revestimento_DescricaoMaterial', 'multi_edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_tipo_revestimento_search', $editor, $this->dataset, $lookupDataset, 'idMaterial', 'DescricaoMaterial', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('tipo_interferncia', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Interferência', 'idInterferencia', 'idInterferencia_tipo_interferncia', 'multi_edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idInterferencia_search', $editor, $this->dataset, $lookupDataset, 'idInterferencia', 'tipo_interferncia', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('Nome Operador', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Usuário', 'id_gerenciador', 'id_gerenciador_Nome Operador', 'insert_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_id_gerenciador_search', $editor, $this->dataset, $lookupDataset, 'idUsuario', 'Nome Operador', '');
            $editColumn->SetReadOnly(true);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            ...
            $lookupDataset->setOrderByField('Lote', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Lote', 'idConcessiona', 'idConcessiona_Lote', 'insert_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idConcessiona_search', $editor, $this->dataset, $lookupDataset, 'idConcessiona', 'Lote', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('DescricaoPista', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Pista', 'idPista', 'idPista_DescricaoPista', 'insert_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idPista_search', $editor, $this->dataset, $lookupDataset, 'idPista', 'DescricaoPista', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('Descricao', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Sentido tráfego (quilometragem)', 'idSentidotrafego', 'idSentidotrafego_Descricao', 'insert_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idSentidotrafego_search', $editor, $this->dataset, $lookupDataset, 'idSentidotrafego', 'Descricao', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('DescricaoFaixa', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Faixa', 'idFaixa', 'idFaixa_DescricaoFaixa', 'insert_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idFaixa_search', $editor, $this->dataset, $lookupDataset, 'idFaixa', 'DescricaoFaixa', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('DescricaoVia', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Via', 'id_via', 'id_via_DescricaoVia', 'insert_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_id_via_search', $editor, $this->dataset, $lookupDataset, 'idVia', 'DescricaoVia', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('DescricaoSecao', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Seção Terrap.', 'id_secao_terrap', 'id_secao_terrap_DescricaoSecao', 'insert_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_id_secao_terrap_search', $editor, $this->dataset, $lookupDataset, 'idSecao', 'DescricaoSecao', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('DescricaoMaterial', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Tipo Revestimento', 'tipo_revestimento', 'tipo_revestimento_DescricaoMaterial', 'insert_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_tipo_revestimento_search', $editor, $this->dataset, $lookupDataset, 'idMaterial', 'DescricaoMaterial', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('tipo_interferncia', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Interferência', 'idInterferencia', 'idInterferencia_tipo_interferncia', 'insert_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idInterferencia_search', $editor, $this->dataset, $lookupDataset, 'idInterferencia', 'tipo_interferncia', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('Nome Operador', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_id_gerenciador_search', 'idUsuario', 'Nome Operador', null, 20);
            ...
            $lookupDataset->setOrderByField('Lote', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idConcessiona_search', 'idConcessiona', 'Lote', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('DescricaoPista', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idPista_search', 'idPista', 'DescricaoPista', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Descricao', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idSentidotrafego_search', 'idSentidotrafego', 'Descricao', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('DescricaoFaixa', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idFaixa_search', 'idFaixa', 'DescricaoFaixa', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('DescricaoVia', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_id_via_search', 'idVia', 'DescricaoVia', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('DescricaoSecao', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_id_secao_terrap_search', 'idSecao', 'DescricaoSecao', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('DescricaoMaterial', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_tipo_revestimento_search', 'idMaterial', 'DescricaoMaterial', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('tipo_interferncia', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idInterferencia_search', 'idInterferencia', 'tipo_interferncia', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Nome Operador', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_id_gerenciador_search', 'idUsuario', 'Nome Operador', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Lote', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idConcessiona_search', 'idConcessiona', 'Lote', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('DescricaoPista', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idPista_search', 'idPista', 'DescricaoPista', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Descricao', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idSentidotrafego_search', 'idSentidotrafego', 'Descricao', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('DescricaoFaixa', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idFaixa_search', 'idFaixa', 'DescricaoFaixa', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('DescricaoVia', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_id_via_search', 'idVia', 'DescricaoVia', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('DescricaoSecao', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_id_secao_terrap_search', 'idSecao', 'DescricaoSecao', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('DescricaoMaterial', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_tipo_revestimento_search', 'idMaterial', 'DescricaoMaterial', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('tipo_interferncia', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idInterferencia_search', 'idInterferencia', 'tipo_interferncia', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Nome Operador', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_id_gerenciador_search', 'idUsuario', 'Nome Operador', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Lote', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idConcessiona_search', 'idConcessiona', 'Lote', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('DescricaoPista', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idPista_search', 'idPista', 'DescricaoPista', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Descricao', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idSentidotrafego_search', 'idSentidotrafego', 'Descricao', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('DescricaoFaixa', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idFaixa_search', 'idFaixa', 'DescricaoFaixa', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('DescricaoVia', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_id_via_search', 'idVia', 'DescricaoVia', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('DescricaoSecao', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_id_secao_terrap_search', 'idSecao', 'DescricaoSecao', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('DescricaoMaterial', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_tipo_revestimento_search', 'idMaterial', 'DescricaoMaterial', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('tipo_interferncia', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idInterferencia_search', 'idInterferencia', 'tipo_interferncia', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Nome Operador', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_id_gerenciador_search', 'idUsuario', 'Nome Operador', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Lote', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idConcessiona_search', 'idConcessiona', 'Lote', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('DescricaoPista', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idPista_search', 'idPista', 'DescricaoPista', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Descricao', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idSentidotrafego_search', 'idSentidotrafego', 'Descricao', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('DescricaoFaixa', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idFaixa_search', 'idFaixa', 'DescricaoFaixa', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('DescricaoVia', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_id_via_search', 'idVia', 'DescricaoVia', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('DescricaoSecao', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_id_secao_terrap_search', 'idSecao', 'DescricaoSecao', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('DescricaoMaterial', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_tipo_revestimento_search', 'idMaterial', 'DescricaoMaterial', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('tipo_interferncia', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_idInterferencia_search', 'idInterferencia', 'tipo_interferncia', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class tbl_usuarios_concessionarias01_tbl_ano_contratualPage extends DetailPage
    {
        protected function DoBeforeCreate()
        {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_id_concessionaria_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('id_concessionaria', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_id_concessionaria_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_idtbl_ano_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('idtbl_ano', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_idtbl_ano_search');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserPermissionsForPage('tbl_usuarios_concessionarias01.tbl_ano_contratual.monitoramento_igg')->HasViewGrant() && $withDetails)
            {
            //
            // View column for tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg detail
            //
            $column = new DetailColumn(array('id_concessionaria', 'idanocontratual', 'idtbl_ano'), 'tbl_usuarios_concessionarias01.tbl_ano_contratual.monitoramento_igg', 'tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_handler', $this->dataset, 'MONITORAMENTO IGG');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Concessionária', 'id_concessionaria', 'id_concessionaria_NomeConcessionaria', 'edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_id_concessionaria_search', $editor, $this->dataset, $lookupDataset, 'idConcessiona', 'NomeConcessionaria', '');
            $editColumn->SetReadOnly(true);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Ano Contratual', 'idtbl_ano', 'idtbl_ano_ano', 'edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_idtbl_ano_search', $editor, $this->dataset, $lookupDataset, 'ano', 'ano', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        }
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('NomeConcessionaria', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Concessionária', 'id_concessionaria', 'id_concessionaria_NomeConcessionaria', 'multi_edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_id_concessionaria_search', $editor, $this->dataset, $lookupDataset, 'idConcessiona', 'NomeConcessionaria', '');
            $editColumn->SetReadOnly(true);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('ano', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Ano Contratual', 'idtbl_ano', 'idtbl_ano_ano', 'multi_edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_idtbl_ano_search', $editor, $this->dataset, $lookupDataset, 'ano', 'ano', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddMultiEditColumn($editColumn);
        }
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('NomeConcessionaria', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Concessionária', 'id_concessionaria', 'id_concessionaria_NomeConcessionaria', 'insert_tbl_usuarios_concessionarias01_tbl_ano_contratual_id_concessionaria_search', $editor, $this->dataset, $lookupDataset, 'idConcessiona', 'NomeConcessionaria', '');
            $editColumn->SetReadOnly(true);
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('ano', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Ano Contratual', 'idtbl_ano', 'idtbl_ano_ano', 'insert_tbl_usuarios_concessionarias01_tbl_ano_contratual_idtbl_ano_search', $editor, $this->dataset, $lookupDataset, 'ano', 'ano', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            $detailPage = new tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_iggPage('tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg', $this, array('id_concessionaria', 'idanocontratual', 'idtbl_ano'), array('id_concessionaria', 'idanocontratual', 'idtbl_ano'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('tbl_usuarios_concessionarias01.tbl_ano_contratual.monitoramento_igg'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('tbl_usuarios_concessionarias01.tbl_ano_contratual.monitoramento_igg'));
            $detailPage->SetHttpHandlerName('tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_handler');
            $handler = new PageHTTPHandler('tbl_usuarios_concessionarias01_tbl_ano_contratual_monitoramento_igg_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('NomeConcessionaria', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_tbl_usuarios_concessionarias01_tbl_ano_contratual_id_concessionaria_search', 'idConcessiona', 'NomeConcessionaria', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('ano', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_tbl_usuarios_concessionarias01_tbl_ano_contratual_idtbl_ano_search', 'ano', 'ano', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('NomeConcessionaria', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_id_concessionaria_search', 'idConcessiona', 'NomeConcessionaria', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('ano', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_tbl_usuarios_concessionarias01_tbl_ano_contratual_idtbl_ano_search', 'ano', 'ano', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('NomeConcessionaria', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_id_concessionaria_search', 'idConcessiona', 'NomeConcessionaria', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('ano', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_idtbl_ano_search', 'ano', 'ano', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('NomeConcessionaria', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_id_concessionaria_search', 'idConcessiona', 'NomeConcessionaria', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('ano', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_tbl_usuarios_concessionarias01_tbl_ano_contratual_idtbl_ano_search', 'ano', 'ano', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    class tbl_usuarios_concessionarias01Page extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('IGG CONCESSIONÁRIA');
            $this->SetMenuLabel('IGG CONCESSIONÁRIA');
            ...
            $this->dataset->AddCustomCondition(EnvVariablesUtils::EvaluateVariableTemplate($this->GetColumnVariableContainer(), '(SELECT id_usuario_cs = %CURRENT_USER_ID%)
        ...
        protected function setupColumnFilter(ColumnFilter $columnFilter)
        {
            ...
            $columnFilter
                ->setNumberOfValuesToDisplayFor('id_concessionaria', 100);
        }
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_tbl_usuarios_concessionarias01_id_concessionaria_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('id_concessionaria', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_tbl_usuarios_concessionarias01_id_concessionaria_search');
            ...
            $main_editor->setMinimumInputLength(0);
            $main_editor->SetAllowNullValue(false);
            $main_editor->SetHandlerName('filter_builder_tbl_usuarios_concessionarias01_id_usuario_cs_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('id_usuario_cs', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_tbl_usuarios_concessionarias01_id_usuario_cs_search');
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            if (GetCurrentUserPermissionsForPage('tbl_usuarios_concessionarias01.tbl_ano_contratual')->HasViewGrant() && $withDetails)
            {
            //
            // View column for tbl_usuarios_concessionarias01_tbl_ano_contratual detail
            //
            $column = new DetailColumn(array('id_concessionaria'), 'tbl_usuarios_concessionarias01.tbl_ano_contratual', 'tbl_usuarios_concessionarias01_tbl_ano_contratual_handler', $this->dataset, 'ANO IGG');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $grid->AddViewColumn($column);
            }
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('NomeConcessionaria', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Concessionária', 'id_concessionaria', 'id_concessionaria_NomeConcessionaria', 'edit_tbl_usuarios_concessionarias01_id_concessionaria_search', $editor, $this->dataset, $lookupDataset, 'idConcessiona', 'NomeConcessionaria', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
            ...
            $editColumn = new DynamicLookupEditColumn('Usuário', 'id_usuario_cs', 'id_usuario_cs_Usuario', 'edit_tbl_usuarios_concessionarias01_id_usuario_cs_search', $editor, $this->dataset, $lookupDataset, 'idUsuario', 'Usuario', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddEditColumn($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('NomeConcessionaria', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Concessionária', 'id_concessionaria', 'id_concessionaria_NomeConcessionaria', 'insert_tbl_usuarios_concessionarias01_id_concessionaria_search', $editor, $this->dataset, $lookupDataset, 'idConcessiona', 'NomeConcessionaria', '');
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
            ...
            $lookupDataset->setOrderByField('Usuario', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Usuário', 'id_usuario_cs', 'id_usuario_cs_Usuario', 'insert_tbl_usuarios_concessionarias01_id_usuario_cs_search', $editor, $this->dataset, $lookupDataset, 'idUsuario', 'Usuario', '');
        ...
        protected function doRegisterHandlers() {
            $detailPage = new tbl_usuarios_concessionarias01_tbl_ano_contratualPage('tbl_usuarios_concessionarias01_tbl_ano_contratual', $this, array('id_concessionaria'), array('id_concessionaria'), $this->GetForeignKeyFields(), $this->CreateMasterDetailRecordGrid(), $this->dataset, GetCurrentUserPermissionsForPage('tbl_usuarios_concessionarias01.tbl_ano_contratual'), 'UTF-8');
            $detailPage->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource('tbl_usuarios_concessionarias01.tbl_ano_contratual'));
            $detailPage->SetHttpHandlerName('tbl_usuarios_concessionarias01_tbl_ano_contratual_handler');
            $handler = new PageHTTPHandler('tbl_usuarios_concessionarias01_tbl_ano_contratual_handler', $detailPage);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('NomeConcessionaria', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_tbl_usuarios_concessionarias01_id_concessionaria_search', 'idConcessiona', 'NomeConcessionaria', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Usuario', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_tbl_usuarios_concessionarias01_id_usuario_cs_search', 'idUsuario', 'Usuario', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('NomeConcessionaria', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_tbl_usuarios_concessionarias01_id_concessionaria_search', 'idConcessiona', 'NomeConcessionaria', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Usuario', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_tbl_usuarios_concessionarias01_id_usuario_cs_search', 'idUsuario', 'Usuario', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('NomeConcessionaria', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_tbl_usuarios_concessionarias01_id_concessionaria_search', 'idConcessiona', 'NomeConcessionaria', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('Usuario', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_tbl_usuarios_concessionarias01_id_usuario_cs_search', 'idUsuario', 'Usuario', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new tbl_usuarios_concessionarias01Page("tbl_usuarios_concessionarias01", "tbl_usuarios_concessionarias01.php", GetCurrentUserPermissionsForPage("tbl_usuarios_concessionarias01"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("tbl_usuarios_concessionarias01"));
